<?php
    ...
    session_start();
    define("ADMINURL","http://localhost/luxInn/admin-panel");
?>
...
<div id="wrapper">
    <nav class="navbar header-top fixed-top navbar-expand-lg  navbar-dark bg-dark">
      <div class="container">
      <a class="navbar-brand" href="<?php echo ADMINURL;?>">Lux Inn Admin</a>
      ...
      <li class="nav-item mt-5 ml-5 mb-3 d-flex justify-content-center align-items-center" 
        style="border-radius: 50%; background: white; width: 100px; height: 100px;">
        <img src="http://localhost/luxInn/images/logoC.png" alt="Lux Inn Logo" style="height: 80px; width: 90px; border-radius: 50%;">
          ...
          <li class="nav-item">
            <a class="nav-link" href="<?php echo ADMINURL;?>/contact-admins/showContacts.php" style="margin-left: 20px;">Contact Box</a>
          </li>
        </ul>
        <?php endif?>
